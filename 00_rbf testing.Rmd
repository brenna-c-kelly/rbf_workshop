...
- can improve predictions but also improve understanding (spatial autocorrelation)  
...
## IDW gives roundness; more flexible functions may be preferred
...
Note that the RBF model changes feature importance — cadmium is relatively less important than it was in the original model, and it's also less important than copper.
